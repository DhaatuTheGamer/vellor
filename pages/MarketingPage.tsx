      ...
      <section id="open-source" data-pomelli-section="open-source" className="py-24 px-4 bg-gray-900 border-t border-gray-800 relative z-20 overflow-hidden text-center text-white">
         ...
         <div className="max-w-4xl mx-auto relative z-10">
             ...
             <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                 <a href="https://github.com/dhaatrik/vellor" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-gray-800 border border-gray-700 px-8 py-5 rounded-2xl hover:bg-gray-700 transition group w-full sm:w-auto shadow-2xl hover:-translate-y-1 duration-300">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                  ...
                  <div>
                      ...
                      <ul className="space-y-3 text-sm text-gray-500 dark:text-gray-400">
                          ...
                          <li><a href="https://github.com/dhaatrik/vellor/releases" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">Changelog (v4.0)</a></li>
                      </ul>
                  </div>
                  ...
                  <div>
                      ...
                      <ul className="space-y-3 text-sm text-gray-500 dark:text-gray-400">
                          <li><a href="https://github.com/dhaatrik/vellor" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">Developer API</a></li>
                          <li><button onClick={() => setIsAdviceOpen(true)} className="hover:text-accent transition-colors">Friendly Tutor Advice</button></li>
                          <li><a href="https://github.com/dhaatrik/vellor" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">Open Source</a></li>
                      </ul>
                  </div>
